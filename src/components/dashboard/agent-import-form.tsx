...
import { Upload, FileText, XCircle, ShieldCheck } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      {result && (
        <ImportSummary
          result={result}
          title="Import complete — credited to you as self-sourced"
          subtitle="Leads already in the system were skipped, not re-created."
        />
      )}
    </div>
  );

            ...
            {source === "google_places" && (
              <>
                ...
                <div>
                  ...
                  <Input
                    placeholder="e.g. best, top rated"
                    value={keyword}
            ...
            {source === "google_search" && (
              <>
                ...
                <div>
                  ...
                  <Input
                    placeholder="Optional additional keyword"
                    value={keyword}
                    onChange={(e) => setKeyword(e.target.value)}
                    className="mt-1"
                  />
                ...
                <div className="rounded-lg bg-zinc-800/50 p-3">
                  <p className="text-xs text-zinc-400">
                    ...
                    Searches for business websites directly.
                  </p>
                </div>
              </>
            )}
                ...
                {manualRows.map((row, i) => (
                  <div key={i} className="grid grid-cols-12 gap-2 items-center">
                    <Input
                      ...
                      onChange={(e) => updateManualRow(i, "business_name", e.target.value)}
                    />
                    <Input
                      className="col-span-2"
                      placeholder="City"
                      value={row.city}
                      onChange={(e) => updateManualRow(i, "city", e.target.value)}
                    />
                    <Input
                      className="col-span-1"
                      placeholder="ST"
                      value={row.state}
                      onChange={(e) => updateManualRow(i, "state", e.target.value)}
                    />
                    <Input
                      className="col-span-4"
                      placeholder="website.com"
                      value={row.website}
                      onChange={(e) => updateManualRow(i, "website", e.target.value)}
                    />
                    <button
